...
export function ExecutiveROIPlanner({ trustScore }: { trustScore: number }) {
  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="pt-16 pb-12">
      ...
      <div id="executive-brief-content">
        {/* KPI Cards */}
      ...
      <div id="roi-report-content">
        ...
        <div className="space-y-10 mb-12">
          <motion.div id="roadmap-content" variants={itemVariants}>
      ...
      <motion.div variants={itemVariants} className="pt-8 border-t border-slate-200 flex flex-col md:flex-row items-center justify-center gap-4">
         <Button 
           onClick={() => exportMasterReport('Executive_ROI_Report.pdf')}
         ...
         <Button 
           onClick={() => exportMasterReport('Executive_Brief.pdf')}
           size="lg" className="rounded-full bg-indigo-600 hover:bg-indigo-700 text-white w-full sm:w-auto shadow-xl px-8 h-14"
         >
           <FileText className="w-5 h-5 mr-2" /> Download Executive Brief
         </Button>
         <Button 
           onClick={() => exportMasterReport('Implementation_Roadmap.pdf')}
